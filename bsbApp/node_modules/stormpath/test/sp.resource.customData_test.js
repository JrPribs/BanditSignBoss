...
describe('Resources: ', function () {
  ...
  describe('CustomData resource class', function () {
    ...
    describe('when attached to a resource',function(){
      var resource, dataStore, saveResourceStub, deleteResourceStub, sandbox;
      ...
      describe('and multiple properties are removed via remove()',function(){

        before(function(){
          resource.customData.remove('a');
          resource.customData.remove('b');
        });
        describe('and save is called on the parent resource',function(){
          ...
          // });
          it('should make a delete call for each deleted property',function(){

            expect(deleteResourceStub.args[0][0].href).to.equal(resource.href+'/a');
            expect(deleteResourceStub.args[1][0].href).to.equal(resource.href+'/b');
          });
        });
      });
